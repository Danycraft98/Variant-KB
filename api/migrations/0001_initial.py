    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clin_sig', models.CharField(blank=True, choices=[(None, 'Select'), ('Pred: Resistance', 'Pred: Resistance'), ('Pred: Adverse Response', 'Pred: Adverse Response'), ('Pred: Reduced Sensitivity', 'Pred: Reduced Sensitivity'), ('Pred: Sensitivity', 'Pred: Sensitivity'),
                                                                   ...
                                                                   ('Dx: Negative Diagnosis', ' disabled hidden> Dx: Negative Diagnosis')], max_length=25, null=True, verbose_name='Clinical Significance')),
