...
INSERT INTO `accounts_user` VALUES (1,'pbkdf2_sha256$216000$92EjvcTMOKdC$3k7gg1Si0EXNNx3YYAlH7pJvjMYdiO4cUAfQU0AmWFQ=','2020-11-20 01:44:22.260095','admin','irene.chae@uhn.ca',1,1,1,1,1,1,1);
...
CREATE TABLE `api_variant` (
  ...
  `polyphen2_hdiv_pred` varchar(2) DEFAULT NULL,
  `polyphen2_hvar_pred` varchar(2) DEFAULT NULL,
  `sift_pred` varchar(2) DEFAULT NULL,
  `mutationtaster_pred` varchar(2) DEFAULT NULL,
  `mutationassessor_pred` varchar(2) DEFAULT NULL,
  `provean_pred` varchar(2) DEFAULT NULL,
  `lrt_pred` varchar(2) DEFAULT NULL,
  ...
  `jaxckb` varchar(20) DEFAULT NULL,
